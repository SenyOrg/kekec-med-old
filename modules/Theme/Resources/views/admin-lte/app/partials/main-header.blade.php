    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                <!-- Breadcrump -->
                <li>
                    <a href="#" class="text-bold bg-light-blue"><i class="fa fa-heartbeat"></i> KekecMED » Dashboard</a></li>
                <!-- Logs -->
                @if (env('APP_DEBUG'))
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{$vc->getUser()->getImageUrl()}}" class="user-image" alt="User Image">
                        <span class="hidden-xs">{{$vc->getUser()->getFullName()}}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="{{$vc->getUser()->getImageUrl()}}" class="img-circle" alt="User Image">

                            <p>
                                {{$vc->getUser()->getFullName()}}
